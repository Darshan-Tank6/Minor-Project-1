...
router.get("/college/create", (req, res) => {
...
router.get("/department/create/:collegeId", async (req, res) => {
  try {
...
router.post("/department/create/:collegeId", async (req, res) => {
  try {
    const { name } = req.body;
    const college = await College.findById(req.params.collegeId);
    if (!college) return res.status(404).send("College not found");
...
router.get("/college/:collegeId/departments", async (req, res) => {
  try {
    const college = await College.findById(req.params.collegeId);
    if (!college) return res.status(404).send("College not found");
...
router.get("/class/create/:departmentId", async (req, res) => {
  try {
...
router.post("/class/create/:departmentId", async (req, res) => {
  try {
...
router.get("/department/:deptId/classes", async (req, res) => {
  try {
...
router.get("/subject/create/:departmentId", async (req, res) => {
  try {
    const department = await Department.findById(
      req.params.departmentId
    ).populate("college");
...
router.post("/subject/create/:departmentId", async (req, res) => {
  try {
...
router.get("/class/:classId/subject/create", async (req, res) => {
  try {
...
router.post("/class/:classId/subject/create", async (req, res) => {
  try {
    const {
      name,
      type,
...
router.post("/subjects/:id/add-chapter", async (req, res) => {
  try {
...
router.post("/add/teahcer", async (req, res) => {
